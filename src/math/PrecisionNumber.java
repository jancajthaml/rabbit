...
class PrecisionNumber extends MathGlobal implements Cloneable 
{
	...
	PrecisionNumber(PrecisionNumber in)
	{
		maxnw = in.maxnw;
	...
	PrecisionNumber(int maxNW, boolean b)
	{
	...
	PrecisionNumber(boolean b, int precision)
	{
	...
	PrecisionNumber(double ia, int precision)
	{
		maxnw		= precisionToSize(precision);
		mantissa	= new float[maxnw];
		
		dmc(new NumberChunk(ia), this);
	}

	PrecisionNumber(String str)
	{ this(str, precision_digits); }

	PrecisionNumber(String str, int precision)
	{
	...
	public Object clone() 
	{ return new PrecisionNumber(this); }
	...
	public boolean equals(Object o)
	{
		...
		try								{ return 0 == compare(this, (PrecisionNumber)o, nw);	}
		catch(ClassCastException cce)	{ return false;											}
  }

	public int compareTo(Object o)
	{ return compare(this, (PrecisionNumber)o, nw); }
  
	public boolean isNegative()
	{ return (compareTo(new PrecisionNumber(true, 10)) < 0 ); }
	...
	static void add (PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		int i		= 0;
	...
	static void cbrt (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int lnw3			= lnw+3;
		PrecisionNumber f	= new PrecisionNumber(6, false) ;
		PrecisionNumber sk0	= new PrecisionNumber(lnw3,false);
		PrecisionNumber sk1	= new PrecisionNumber(lnw3,false);  
		PrecisionNumber sk2	= new PrecisionNumber(lnw3,false);
		int na				= Math.min (a.number_words, lnw); 
		...
		for (int k = 2; k<=mq - 1;k++)
		{
			...
			while (cont)
			{
				...
				mul (b, sk2, sk1, lnw);
				mpdivd (sk1, new NumberChunk(3.0), sk2, lnw);
		...
		mul (sk1, b, sk2, lnw);
		mpdivd (sk2, new NumberChunk(3.0), sk1, lnw);
	...
	static int compare (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int i	= 0;
		int ic	= 0;      
		int ia	= (a.sign ? 1 : -1 );
	...
	static void mpdiv (PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		int i		= 0;
		int j		= 0;
		double rb	= 0.0;
	...
	static void mpdivd(PrecisionNumber a, NumberChunk b,  PrecisionNumber c, int lnw)
	{
		int j				= 0;
		int k				= 0;
		double bb			= 0.0;
		...
		if (bb != (int)(bb)) 
		{
			dmc (new NumberChunk(fSign(bb, b.a), n1 * 24) , f);
			mpdiv (a, f, c, lnw);
			return;
		}
	...
	static void dmc(NumberChunk a, PrecisionNumber b)
	{
		int i		= 0;
		int k		= 0;
		double aa	= 0.0;
	...
	static void eq(PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int na	= Math.min (a.number_words, lnw);
	...
	static void infr (PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		int na	= Math.min (a.number_words, lnw);
		int ma	= a.exponent;
	...
	static void mdc(PrecisionNumber a, NumberChunk b)
	{
		double aa		= 0.0;
	...
	static  void mul(PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		int i		= 0;
		int j		= 0;
		double t1	= 0.0;
	...
	static void muld (PrecisionNumber a, NumberChunk b, PrecisionNumber c, int lnw)
	{
		int i				= 0;
		int k				= 0;
		double bb			= 0.0;
	...
	static void nint (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int i				= 0;
		PrecisionNumber f	=  new PrecisionNumber(6, false);
		PrecisionNumber s	= new PrecisionNumber(lnw+2,false);
		int na				= Math.min (a.number_words, lnw);
	...
	private static void mpnorm(double d[], PrecisionNumber a, int lnw)
	{
	...
	static void mpnpwr (PrecisionNumber a, int n, PrecisionNumber b, int lnw)
	{
		int j				= 0;
		double t1			= 0.0;
		int lnw3			= lnw+3;
	...
	static void mpnrt (PrecisionNumber a, int n, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		double t2			= 0.0;
		double tn			= 0.0;
		int lnw3			= lnw+3;
		PrecisionNumber f1	= new PrecisionNumber(6, false);
		PrecisionNumber f2	= new PrecisionNumber(6, false);
		PrecisionNumber sk0	= new PrecisionNumber(lnw3,false);
		PrecisionNumber sk1	= new PrecisionNumber(lnw3,false); 
		PrecisionNumber sk2	= new PrecisionNumber(lnw3,false);
		PrecisionNumber sk3	= new PrecisionNumber(lnw3,false);
		int na				= Math.min (a.number_words, lnw);
		...
		if (t1.n <= -30) 
		{
			...
			if (n3 < 1.25 * n2) 
			{
				...
				mpdivd (sk0, new NumberChunk(t2), sk1, lnw);
				add (f1, sk1, sk2, lnw);
				...
				do
				{
					...
					muld (sk1, t1, sk3, lnw);
					mpdivd (sk3, new NumberChunk(t2), sk1, lnw);
					mul (sk0, sk1, sk3, lnw);
					eq (sk3, sk1, lnw);
					add (sk1, sk2, sk3, lnw);
					eq (sk3, sk2, lnw);
		...
		tn			= n;
		NumberChunk dpn	= new NumberChunk(n, 0);
		...
		for (k = 2; k<= mq;k++)
		{
			...
			while (loop)
			{
				...
				sub (f1, sk1, sk0, lnw);
				mul (b, sk0, sk1, lnw);
				mpdivd (sk1, new NumberChunk(tn), sk0, lnw);
				add (b, sk0, sk1, lnw);
				eq (sk1, b, lnw);
	...
	static void rand (PrecisionNumber a, int lnw)
	{
		int i		= 0;
		double t1	= 0.0;
		double t2	= 0.0;
	...
	static void round(PrecisionNumber a, int lnw)
	{
		int i		= 0;
		int a2		= a.exponent;
		a.exponent	= 0;
	...
	static void mpsqrt(PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		double t2			= 0.0;
		int lnw3			= lnw+3;
		...
		int nws		= lnw;
		NumberChunk t1	= new NumberChunk(lnw,0);
		int mq		= (int)(CL2 * Math.log (t1.a) + 1.0 - 5.6843418860808015e-14); // *cast* 
		int iq		= 0;
		...
		for(k = 2; k<= mq - 1; k++)
		{
			...
			while(!stop)
			{
				...
				lnw = nw1;
				mul (b, sk0, sk1, lnw);
				muld (sk1, new NumberChunk(0.50), sk0, lnw);
				lnw = nw2;
				add (b, sk0, sk1, lnw);
				eq (sk1, b, lnw);
		...
		mul (sk2, b, sk1, lnw);
		muld (sk1, new NumberChunk(0.50), sk2, lnw);
	...
	static void sub (PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		PrecisionNumber bb	=	new PrecisionNumber(0,false);
		bb.sign				=!	b.sign;
	...
	static void zero(PrecisionNumber in)
	{
		in.number_words		= 0;
		in.sign				= true;
		in.exponent			= 0;
	...
	NumberChunk toDPE()
	{
		NumberChunk res = new NumberChunk();
		mdc(this, res);
		return res;
	}

	static void inp_complex (char a[], int n, PrecisionNumber b, int lnw)
	{
		int i				= 0;
		int j				= 0;
		int is				= 0;
		...
		int nw3			= lnw+3;
		PrecisionNumber f	= new PrecisionNumber(6, false);
		PrecisionNumber sk0	= new PrecisionNumber(nw3,false); 
		PrecisionNumber sk1	= new PrecisionNumber(nw3,false); 
		PrecisionNumber sk2	= new PrecisionNumber(nw3,false);
		int nws				= lnw++;
		int i1				= 0;
		int nn				= 0;
			...
			for(i = i1; i< n; i++)
			{
				...
				if (ib == 6 || i == (n-1) && ib != 0) 
				{
					if (it != 0) 
					{
						...
						muld (sk2, new NumberChunk(1e6), sk0, lnw);
	...
	static int mpoutc(PrecisionNumber a, char b[], int lnw)
	{
		int i				= 0;
		int j				= 0;
		int k				= 0;
		...
		if (na != 0) 
		{
			...
			while (cont) 
			{
				if (sk1.exponent < 0)
				{
					...
					muld (sk1, new NumberChunk(10.0), sk0, lnw);
					eq (sk0, sk1, lnw);
				}
				else if(sk1.mantissa[0] >= 10) 
				{
					...
					mpdivd (sk1, new NumberChunk(10.0), sk0, lnw);
					eq (sk0, sk1, lnw);
				}
				else cont = false;
			}
		...
		muld (sk0, new NumberChunk(1e6), sk1, lnw);
	...
	static void dexc (char a[], int l, PrecisionNumber b, int lnw)
	{
		int i					= 0;
	...
	static int mpouts (PrecisionNumber a, int la, char[] cs, int lnw)
	{
	...
	static void mpang (PrecisionNumber x, PrecisionNumber y, PrecisionNumber pi, PrecisionNumber a, int lnw)
	{
		int k				= 0;
		int nw3			= lnw+3;
		PrecisionNumber sk0	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk1	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk2	= new PrecisionNumber(nw3,false); 
		PrecisionNumber sk3	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk4	= new PrecisionNumber(nw3,false);
		int ix				= x.sign ? 1 : -1;
		...
		if (nx == 0) 
		{  
			muld (pi, new NumberChunk((iy > 0)?0.5:-0.5), a, lnw);
			return;
		}
		else if (ny == 0) 
		{
		...
		NumberChunk t3	= new NumberChunk();
	...
	static void mpcssh (PrecisionNumber a, PrecisionNumber al2, PrecisionNumber x, PrecisionNumber y, int lnw)
	{
		int nw3			= lnw+3;
		PrecisionNumber f	= new PrecisionNumber(6, false);
		PrecisionNumber sk0	= new PrecisionNumber(nw3,false);
		...
		mpdiv (f, sk0, sk1, lnw);
		add (sk0, sk1, sk2, lnw);
		muld (sk2, new NumberChunk(0.5), sk3, lnw);
		eq (sk3, x, lnw);
		sub (sk0, sk1, sk2, lnw);
		muld (sk2, new NumberChunk(0.5), sk3, lnw);
		eq (sk3, y, lnw);  
	...
	static void ssn_complex (PrecisionNumber a, PrecisionNumber pi, PrecisionNumber x, PrecisionNumber y, int lnw)
	{
		double t2			= 0.0;
		int nw3			= lnw+3;
		PrecisionNumber f	= new PrecisionNumber(6, false); 
		...
		PrecisionNumber sk3	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk4	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk5	= new PrecisionNumber(nw3,false);
		PrecisionNumber sk6	= new PrecisionNumber(nw3,false);
		int na				= Math.min (a.number_words, lnw);
		int l1				= 0;
		...
		muld	(pi, new NumberChunk(2.0), sk0, lnw);
		mpdiv	(a, sk0, sk1, lnw);
		nint	(sk1, sk2, lnw);
		sub		(sk1, sk2, sk3, lnw);
		mdc	(sk3, t1);
		...
		else 
		{
			...
			add (f, sk4, sk5, lnw);
			mpsqrt (sk5, sk3, lnw);
			muld (sk3, new NumberChunk(0.5), sk2, lnw);
			sub (f, sk4, sk5, lnw);
			mpsqrt (sk5, sk4, lnw);
			muld (sk4, new NumberChunk(0.5), sk3, lnw);
		}
	...
	static void mpexp (PrecisionNumber a, PrecisionNumber al2, PrecisionNumber b, int lnw)
	{
		int i				= 0;
		int l1				= 0;
		int nw3			= lnw+3;
		...
		if (!skip)
		{
			mpdivd (sk0, new NumberChunk(1.0, 8), sk1, lnw);
			eq (f, sk2, lnw);
			eq (f, sk3, lnw);
		...
		muld (sk0, new NumberChunk(1.0, nz), sk1, lnw);
		eq (sk1, b, lnw);  
		round (b, nws);
	}

	static void log (PrecisionNumber a, PrecisionNumber al2, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		int nw3			= lnw+3;
		PrecisionNumber sk0	= new PrecisionNumber(nw3,false);
		...
		NumberChunk t1			= new NumberChunk(), t2 = new NumberChunk();
	...
	static void mppi(PrecisionNumber pi, int lnw)
	{
		int k				= 0;
		double t1			= 0.0;
		int nw3			= lnw+3;
		...
		for (k = 1; k<= mq; k++)
		{
			...
			mul (sk0, sk1, sk3, lnw);
			mpsqrt (sk3, sk1, lnw);
			muld (sk2, new NumberChunk(0.50), sk0, lnw);
			sub (sk0, sk1, sk2, lnw);
			mul (sk2, sk2, sk3, lnw);

			t1 = Math.pow(2.0, k);
			
			muld (sk3, new NumberChunk(t1), sk2, lnw);
			sub (sk4, sk2, sk3, lnw);
			eq (sk3, sk4, lnw);
		}
	...
	static void mpcbrx (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		double t1			= 0.0;
		int nw3			= lnw+3;
	...
	static void _div (PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		int k				= 0;
		double t1			= 0.0;
		int nw3			= lnw+3;
	...
	static void _mul(PrecisionNumber a, PrecisionNumber b, PrecisionNumber c, int lnw)
	{
		double t1	= 0.0;
		double t2	= 0.0;
		double t3	= 0.0;
	...
	static void _npw(PrecisionNumber a, int n, PrecisionNumber b, int lnw)
	{
		int j				= 0;
		double t1			= 0.0;
		int nw2			= lnw+2;
	...
	static void _nrt (PrecisionNumber a, int n, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		double t2			= 0.0;
		double tn			= 0.0;
		...
		if (t1.n <= -30) 
		{
			...
			if (n3 < 1.25 * n2) 
			{
				...
				do
				{
					...
					muld (sk1, new NumberChunk(t1.a), sk3, lnw);
					mpdivd (sk3, new NumberChunk(t2), sk1, lnw);
	...
	static void _sqr (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		int nw3			= lnw+3;
		PrecisionNumber f	= new PrecisionNumber(6, false);
	...
	static void _sq(PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		double t1	= 0.0;
		double t2	= 0.0;
		double t3	= 0.0;
	...
	private static void mpagmx (PrecisionNumber a, PrecisionNumber b, int lnw)
	{
		int nw2			= lnw+2;
		PrecisionNumber sk0	= new PrecisionNumber(nw2,false);
		PrecisionNumber sk1	= new PrecisionNumber(nw2,false);  
	...
	static void _cosh (PrecisionNumber a, PrecisionNumber pi, PrecisionNumber al2, PrecisionNumber x, PrecisionNumber y, int lnw)
	{
		...
		f.mantissa[0]		= 1;
		f.mantissa[1]		= 0;
		NumberChunk dpe1			= new NumberChunk(0.5);
	...
	static void _exp (PrecisionNumber a, PrecisionNumber pi, PrecisionNumber al2, PrecisionNumber b, int lnw)
	{
		int k				= 0;
		final int nit		= 1;
		int nw2			= lnw+2;
	...
	static void _log (PrecisionNumber a, PrecisionNumber pi, PrecisionNumber al2, PrecisionNumber b, int lnw)
	{
		final int mzl		= -5;
		double st			= 0.0;
		double tn			= 0.0;
		int nw2			= lnw+2;
		PrecisionNumber f1	= new PrecisionNumber(6, false);
		PrecisionNumber f4	= new PrecisionNumber(6, false); 
		PrecisionNumber sk0	= new PrecisionNumber(nw2,false);
		PrecisionNumber sk1	= new PrecisionNumber(nw2,false); 
		PrecisionNumber sk2	= new PrecisionNumber(nw2,false);
		...
		else if (sk0.exponent <= mzl) 
		{
			...
			do
			{
				...
				mpdivd (sk3, new NumberChunk(st), sk2, lnw);
				add (sk0, sk2, sk3, lnw);
				eq (sk3, sk0, lnw);
			}
		...
		_div (f4, sk0, sk2, lnw);
		mpagmx (sk1, sk2, lnw);
		muld (sk1, new NumberChunk(2.0), sk0, lnw);
		_div (pi, sk0, sk1, lnw);
		...
		{
			muld (al2, new NumberChunk(tn), sk2, lnw);
			sub (sk1, sk2, sk0, lnw);
		}
		eq (sk0, b, lnw);
	}

	static void _pi (PrecisionNumber pi, int lnw)
	{
		int k				= 0;
		double t1			= 0.0;
		int nw2			= lnw+2;
		...
		NumberChunk dpe1			= new NumberChunk(0.50);
	...
	static int outx (PrecisionNumber a, char b[], int lnw)
	{
		int i	= 0;
		int n	= 0;  
		int na	= Math.min (a.number_words, lnw);
		...
		NumberChunk dpe1			= new NumberChunk(10,0); 
		...
		sk1.sign	= true;
		NumberChunk dpe2	= new NumberChunk(), dpe3 = new NumberChunk();
